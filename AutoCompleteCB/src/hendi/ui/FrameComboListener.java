...
public class FrameComboListener extends JFrame 
{
	...
	public FrameComboListener() 
	{
		...
		btnTampilkan.setIcon(new ImageIcon("src/hendi/images/tampilData.png"));
		...
		btnRefresh.setIcon(new ImageIcon("src/hendi/images/Refresh.png"));
		...
		lblIco = new JLabel("");
		lblIco.setIcon(new ImageIcon("src/hendi/images/Pesawat.png"));
		lblIco.setBounds(388, 104, 196, 166);
		contentPane.add(lblIco);
		
		lblBg = new JLabel("");
		lblBg.setIcon(new ImageIcon("src/hendi/images/AirWallpaper.png"));
